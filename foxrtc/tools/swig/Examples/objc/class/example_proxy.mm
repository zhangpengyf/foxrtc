...
-(double)area
{
  return _wrap_Shape_area([self getCptr]); 
}

-(double)perimeter
{
  return _wrap_Shape_perimeter([self getCptr]); 
}
...
-(double)area
{
  return _wrap_Circle_area([self getCptr]); 
}

-(double)perimeter
{
  return _wrap_Circle_perimeter([self getCptr]); 
}
...
-(void)dealloc{
  ...
  if (swigCPtr != NULL) {
    if (swigCMemOwn) {
        _wrap_delete_Circle((void*)swigCPtr);
        swigCMemOwn = NO;
    }
    swigCPtr = NULL;
  }
...
-(double)area
{
  return _wrap_Square_area([self getCptr]); 
}

-(double)perimeter
{
  return _wrap_Square_perimeter([self getCptr]); 
}
...
-(void)dealloc{
  ...
  if (swigCPtr != NULL) {
    if (swigCMemOwn) {
        _wrap_delete_Square((void*)swigCPtr);
        swigCMemOwn = NO;
    }
    swigCPtr = NULL;
  }
...
-(int)GetAge
{
  return _wrap_EventArgs_GetAge([self getCptr]); 
}
