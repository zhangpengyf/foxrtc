...
/* Define if using gccgo before 4.7.0 */
/* #undef HAVE_GCCGO_46 */
...
#define PACKAGE_STRING "swig 2.0.6"
...
#define SWIG_LIB "/usr/local/share/swig/2.0.6"
...
#define SWIG_PLATFORM "x86_64-apple-darwin16.6.0"
