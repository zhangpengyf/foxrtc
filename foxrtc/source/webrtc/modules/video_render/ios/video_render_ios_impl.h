...
#include "base/umcs_scoped_ptr.h"
namespace webrtc {
...
class VideoRenderIosImpl : IVideoRender {
 public:
  ...
  rtc::VideoSinkInterface<VideoFrame>* AddIncomingRenderStream(const uint32_t stream_id,
 ...
 private:
  ...
  umcs::scoped_ptr<VideoRenderIosGles20> ptr_ios_render_;
};
}  // namespace webrtc
